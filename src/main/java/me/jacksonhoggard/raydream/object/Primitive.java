...
public abstract class Primitive implements IPrimitive {
    ...
    public Primitive(Transform transform, Vector3D min, Vector3D max, boolean isLight) {
    ...
    public BVH.BoundingBox getBounds() {
        return new BVH.BoundingBox(getMin(), getMax());
    }
}
